# Generated by Django 5.2.1 on 2025-05-31 05:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('office', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='customers', to='data_pro.office')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='client',
            name='office',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='data_pro.office'),
        ),
        migrations.CreateModel(
            name='Passport',
            fields=[
        ...
        migrations.AddIndex(
            model_name='client',
            index=models.Index(fields=['company_name'], name='data_pro_cl_company_d80827_idx'),
        ),
        migrations.AddIndex(
            model_name='client',
            index=models.Index(fields=['email'], name='data_pro_cl_email_c11170_idx'),
        ),
        migrations.AddIndex(
            model_name='client',
            index=models.Index(fields=['status'], name='data_pro_cl_status_814f3c_idx'),
        ),
        migrations.AddConstraint(
            model_name='client',
            constraint=models.UniqueConstraint(fields=('company_name', 'email'), name='unique_client_company_email'),
        ),
        migrations.AddIndex(
            model_name='transportservice',
            index=models.Index(fields=['reference_number'], name='data_pro_tr_referen_c5a174_idx'),
        ),
        migrations.AddIndex(
            model_name='transportservice',
            index=models.Index(fields=['status'], name='data_pro_tr_status_7aceef_idx'),
        ),
        migrations.AddIndex(
            model_name='transportservice',
            index=models.Index(fields=['scheduled_departure'], name='data_pro_tr_schedul_fa3373_idx'),
        ),
    ]
